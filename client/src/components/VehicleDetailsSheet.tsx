...
export default function VehicleDetailsSheet({ vehicle, onClose }: { vehicle: any; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative w-full max-w-md bg-white rounded-t-3xl p-5 pb-8 max-h-[88vh] overflow-y-auto animate-in slide-in-from-bottom duration-300">
        <button
          onClick={onClose}
          aria-label="Fechar"
          className="absolute top-4 right-4 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center go-btn-active z-10"
        >
